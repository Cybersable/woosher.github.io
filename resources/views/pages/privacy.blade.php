...
@section('content')
    <section class="policy">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="page-top-text text-light">
                        <h2>ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ САЙТА WOOSHER.RU</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col">
                    <div id="inputResult">
                        <div class="row mb-4">
                            <div class="col">
                                <h3 class="section-title">Политика в отношении обработки персональных данных</h3>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <div class="descr">Настоящая политика обработки персональных данных
                                    ...
                                    данных и меры по обеспечению безопасности персональных данных, предпринимаемые Дмитриев Евгений Дмитриевич (далее – Оператор).</div>
                                ...
                                <div class="ol">
                                    ...
                                    <div class="li">1.2. Настоящая политика Оператора в отношении обработки персональных данных
                                        ...
                                        получить о посетителях веб-сайта http://woosher.ru.</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">&nbsp;</div>
                            ...
                            <div class="col">
                                ...
                                <div class="ol">
                                    ...
                                    <div class="li">2.3. Веб-сайт – совокупность графических и информационных материалов, а
                                        ...
                                        по сетевому адресу http://woosher.ru;</div>
                                    ...
                                    <div class="li">2.8. Персональные данные – любая информация, относящаяся прямо или косвенно
                                        к
                                        определенному или определяемому Пользователю веб-сайта http://woosher.ru;</div>
                                    <div class="li">2.9. Пользователь – любой посетитель веб-сайта http://woosher.ru;</div>
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <div id="dataTargetResult" class="ol">
                                    ...
                                    <div>3.5. Вышеперечисленные данные далее по тексту Политики объединены общим понятием Персональные данные.</div></div>
                            </div>
                        </div>
                        <div class="row">&nbsp;</div>
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <div class="ol">
                                    <div class="li">4.1. Цель обработки персональных данных Пользователя — информирование Пользователя об услугах посредством мессенджеров или телефонного звонка.</div>
                                    <div class="li">4.2. Также Оператор имеет право направлять Пользователю уведомления о новых
                                        ...
                                        направив Оператору письмо на адрес электронной почты support@woosher.ru с пометкой «Отказ от
                            ...
                            <div class="col">
                                ...
                                <div class="ol">
                                    <div class="li">5.1. Оператор обрабатывает персональные данные Пользователя только в случае
                                        ...
                                        формы, расположенные на сайте http://woosher.ru. Заполняя соответствующие формы
                            ...
                            <div class="col">
                                ...
                                <div class="ol">
                                    ...
                                    <div class="li">6.3. В случае выявления неточностей в персональных данных, Пользователь может
                                        ...
                                        на адрес электронной почты Оператора support@woosher.ru с пометкой «Актуализация
                                        персональных данных».</div>
                                    <div class="li">6.4. Срок обработки персональных данных является неограниченным. Пользователь
                                        ...
                                        электронный адрес Оператора support@woosher.ru с пометкой «Отзыв согласия на
                            ...
                            <div class="col">
                                ...
                                <div class="ol">
                                    <div class="li">8.1. Пользователь может получить любые разъяснения по интересующим вопросам,
                                        ...
                                        помощью электронной почты support@woosher.ru.</div>
                                    ...
                                    <div class="li">8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет
                                        по адресу http://woosher.ru/privacy-policy.</div>
                                </div>
                            </div>
                        </div>
                    </div>
